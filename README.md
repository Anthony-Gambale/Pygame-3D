...
This technique has the potential to be much faster than current 3D renderering techniques, if there are no major issues with implementing it into a real 3D 